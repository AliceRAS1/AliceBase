AliceBase is a fast key-value storage added many new features based on LevelDB.

# New Features
 * support serializable transaction based on SSI algorithm.


# below is LevelDB doc.
